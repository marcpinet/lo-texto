...
* **Marc Pinet** - *Lora, Bluetooth and server* - [marcpinet](https://github.com/marcpinet)
* **Lyne El Dada** - *Devices, TheThingsNetwork and database* - [flakvatrev](https://github.com/flakvatrev)
* **Loïc Pantano** - *Application backend and Bluetooth communication* - [loicpantano](https://github.com/loicpantano)
* **Marcus Aas Jensen** - *Application frontend and logo* - [marcusaasjensen](https://github.com/marcusaasjensen)
